...
public class SortByPriceTest {
    ...
    public void test1(){
        ...
        Item item2= new Item(1L, "Hand Bag", 2.5);
        Item item1= new Item(8L, "Lunch Bag ", 3.5);
        Item item3= new Item(6L, "Tote Bag", 1.5);
        Item[] itemSort = {item2, item1, item3};
        Item[] expected ={item3, item2, item1};
        ItemSorter itemSorting = new ItemSorter(itemSort);
        Comparator<Item> comparator =  (Comparator<Item>)new PriceComparator();


        //When
        Item[] actual = itemSorting.sort(comparator);
